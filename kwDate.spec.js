describe('kwDate', function() {
    var d;

    beforeEach(function() {
        d = new kwDate('03/12/2015');
    });
    ...
    it('should take no argument and return a date object representing today', function() {
        expect(new kwDate().toUTCString()).toEqual(new Date().toUTCString());
    })
    ...
    it('should take a date and return a date object', function() {
        var d1UTC = new kwDate(new Date('03/10/2015')).toUTCString();
    ...
    it('should take a date in GMT format and handle it properly', function() {
        var d1UTC = new kwDate('2015-03-10').toUTCString();
        var d2UTC = new Date('03/10/2015').toUTCString();
    ...
    it('.getDateAt should return a kwDate object', function() {
